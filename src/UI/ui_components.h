...
function UI_Action UI_Text(Str8 string);
function UI_Action UI_Text(char* fmt, ...);

function void UI_Space(UI_Size size);
#define UI_Padding(size) ScopedContextBlock(UI_Space(size), UI_Space(size))

function UI_Action UI_Button(Str8 string);
function UI_Action UI_Button(char* fmt, ...);
